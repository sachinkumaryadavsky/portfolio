      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="space-y-10">
          ...
          >
            ...
            <p className="text-indigo-400">Gurukul Vidyapeeth, Bihar</p>
            <p className="text-gray-400">
              2019 – 2020 | Percentage:{' '}
              <span className="text-white font-semibold">91.4%</span>
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-indigo-400">B.D. Public School, Bihar</p>
            <p className="text-gray-400">
              2017 – 2018 | Percentage:{' '}
              <span className="text-white font-semibold">93.17%</span>
            </p>
          </motion.div>
        </div>
      </div>
