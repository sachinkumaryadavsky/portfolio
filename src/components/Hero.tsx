...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center bg-gray-950 text-white "
    >
      {/* LEFT SIDE GLOW */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
        ...
        <div className="space-y-10">
          ...
          <p className="text-gray-400 text-lg leading-relaxed max-w-xl">
            I engineer scalable, high-performance backend systems focused on
            reliability, system efficiency, and real-world production impact.
          </p>

          {/* Tech Stack Chips */}
          <div className="flex flex-wrap gap-3 pt-2">
            {["Node.js", "C++", "TypeScript", "Go", "MySQL", "DSA"].map((tech) => (
              <span
                key={tech}
