    ...
    <section id="projects" className="py-24 bg-gray-950 text-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-black mb-16 text-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-[0_0_8px_rgba(139,92,246,0.4)]"
        >
          Projects
        </motion.h2>
        ...
        >
          ...
          <p className="text-gray-400 mb-8 leading-relaxed">
            Developed an AI-powered health companion enabling multimodal image analysis 
            and symptom tracking with non-diagnostic guidance. Integrated Google Gemini 
            multimodal APIs with strict JSON schema validation and real-time 
            environmental data via OpenWeather APIs.
          </p>
...
<div className="grid md:grid-cols-2 gap-8">
  ...
  >
    ...
    <p className="text-gray-400 leading-relaxed mb-4">
      Designed and developed a full-stack web-based Placement Portal to streamline 
      the campus recruitment workflow for students, TNP representatives, and TPOs.
    </p>
  ...
  >
    ...
    <p className="text-gray-400 leading-relaxed mb-4">
      Developed a real-time messaging platform enabling instant communication 
      with persistent chat history and scalable backend architecture.
    </p>
  ...
  {[
    ...
    <div className="flex flex-wrap gap-2 mb-4">
      {["Node.js", "Express", "Socket.IO", "MongoDB", "React"].map((tech) => (
        <span
          key={tech}
          className="text-xs bg-gray-800 px-3 py-1 rounded-full text-indigo-400"
        >
